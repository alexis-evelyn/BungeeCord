    ...
    public void rewriteClientbound(ByteBuf packet, int oldId, int newId, int protocolVersion)
    {
        ...
        switch ( packetId )
        {
            ...
            case 0x00 /* Spawn Object : PacketPlayOutSpawnEntity */:
                ...
                {
                    // NOTE: UUID was removed for arrows and spectral arrows, so I removed the adding + 1 to both entity types
                    // Tridents are considered an abstract arrow too, so they are also affected
                    /*
